          ...
          <tbody>
            <tr>
              ...
              <td colspan="2" style="border: none;">Hasil uji ini mewakili populasi yang diambil/Hasil uji ini hanya
                ...
                <i>The result of the test represent the population taken/This result of the test are only valid for the
                  tested sample**)</i>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <!-- Menampilkan nomor urut -->
              <td width="1%" style="border: none;">.</td> <!-- Menampilkan nomor urut -->
              <td colspan="2" style="border: none;">Laporan hasil uji ini tidak boleh digandakan, kecuali secara lengkap
