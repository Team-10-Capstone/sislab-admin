                                    ...
                                    <?php foreach ($permohonans as $keypermohonan => $permohonan): ?>
                                        ...
                                        <div class="box h-max">
                                            <div class="box-body">
                                                ...
                                                <div class="relative h-full transition-all duration-500"
                                                    ...
                                                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
                                                        <?php foreach ($permohonan['dtl_fppc'] as $key => $sampel): ?>
                                                            <div class="box mb-3">
                                                                ...
                                                                <div class="box-body">
                                                                    <div>
                                                                        ...
                                                                        <select class="ti-form-select blog-tag2" multiple
                                                                            ...
                                                                            name="disposisi[<?= $keypermohonan + 1; ?>][sampel][<?= $key + 1; ?>][analis][]">
                                                                ...
                                                                <input type="hidden"
                                                                    name="disposisi[<?= $keypermohonan + 1; ?>][sampel][<?= $key + 1; ?>][permohonan_uji_id]"
                                                                    value="<?= $sampel['permohonan_uji_id']; ?>">
                                                                <input type="hidden"
                                                                    name="disposisi[<?= $keypermohonan + 1; ?>][sampel][<?= $key + 1; ?>][dtl_fppc_id]"
...
<script src="<?php echo base_url('assets/js/disposisi-analis.js'); ?>"></script>
