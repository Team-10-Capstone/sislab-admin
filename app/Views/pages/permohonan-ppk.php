            ...
            <div class="col-span-12">
                <div class="box">
                    <div class="box-header lg:flex lg:justify-between">
                        <h5 class="box-title my-auto">Daftar permohonan</h5>
                    ...
                    <div class="box-body">
                        <div class="xl:flex xl:justify-between space-y-3 xl:space-y-0">
                            <div class="sm:flex sm:space-x-3 space-y-3 sm:space-y-0 rtl:space-x-reverse">
                                <form class="relative max-w-xs" method="get"
                                    action="<?= site_url('ppkController/index') ?>" onsubmit="return false;">
                            ...
                            <div class="sm:space-x-3 sm:flex space-y-3 sm:space-y-0 rtl:space-x-reverse">
                                ...
                                <div class="hs-dropdown ti-dropdown">
                                    ...
                                    <div aria-labelledby="hs-dropdown-transform-style" data-hs-transition
                            ...
                            <table
                                ...
                                <thead class="bg-gray-50 dark:bg-black/20">
                                    <tr class="cart-box">
                                        ...
                                        <th scope="col" class="dark:text-white/70">Jenis Permohonan</th>
                                            ...
                                            <td class="max-w-sm overflow-hidden">
                                                <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                    <div class="block">
                                                        <p
                                                            class="block text-sm font-semibold text-gray-800 dark:text-white my-auto">
                                                            <?php echo $row['nm_penerima']; ?>
                                                        </p>
                                                        </p>
                                                        <p class="block text-xs text-gray-500 dark:text-white/70 my-auto">
                                                            <?php echo $row['al_penerima']; ?>
                                                        </p>
                                                        </p>
                                                    </div>
                                                </div>
    ...
    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out sm:!max-w-6xl">
        <div class="ti-modal-content">
            <div class="ti-modal-header">
                ...
                <button type="button" class="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#invoice-modal">
            ...
            <div class="ti-modal-body p-6">
                <div class="flex flex-col md:flex-row space-y-6 justify-between mb-5">
                    <div class="space-y-2">
                        <div class="mb-2">
                            <img src="<?php echo base_url('assets/img/brand-logos/desktop-logo.png'); ?>" alt="logo"
                                class="flex dark:hidden">
                            <img src="<?php echo base_url('assets/img/brand-logos/desktop-dark.png'); ?>" alt="logo"
                        ...
                        <input type="text" class="company-address1 ti-form-input md:w-72"
                            placeholder="Complete Address">
                    </div>
                    <div class="space-y-2 text-end inline-block">
                        <h3 class="text-2xl text-primary uppercase font-semibold">Invoice</h3>
                        <input type="text" class="invoice-id ti-form-input md:w-72 inline-block text-end"
                            placeholder="Invoice Id">
                        <div class="mt-1 flex"><input type="text"
                                class="create-date ti-form-input md:w-72 text-end sm:ltr:ml-3 sm:rtl:mr-3 flatpickr-input invoice-date font-normal"
                                placeholder="created date" readonly></div>
                        <div class="mt-1 flex"><input type="text"
                                class="due-date ti-form-input md:w-72 text-end sm:ltr:ml-3 sm:rtl:mr-3 flatpickr-input invoice-date font-normal"
                                placeholder="Due Date" readonly></div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-12 gap-6 mb-5">
                    <div class="lg:col-span-6 col-span-12">
                        <div class="space-y-3 inline-block">
                            ...
                            <input type="text" class="company-name ti-form-input md:w-72" placeholder="Company Name">
                            <input type="text" class="company-address ti-form-input md:w-72"
                    ...
                    <div class="lg:col-span-6 col-span-12 text-end">
                        <div class="space-y-3 inline-block">
                            ...
                            <input type="text" class="company-name ti-form-input md:w-72 text-end"
                                placeholder="Company Name">
                            <input type="text" class="company-address ti-form-input md:w-72 text-end"
                                placeholder="Company Address">
                            <input type="text" class="company-address1 ti-form-input md:w-72 text-end"
                                placeholder="Complete Address">
                        </div>
                    </div>
                </div>
                <div class="sm:flex space-y-4 justify-between">
                    ...
                    <a href="javascript:void(0);" class="invoice-add-item ti-btn ti-btn-primary m-0 py-2"><i
                            class="ri ri-add-line"></i>Add Item Deatils</a>
                </div>
                <div class="py-5">
                        ...
                        <table class="ti-custom-table !border dark:border-white/10 !border-x-0 text-center">
                            ...
                            <tbody class="invoice-body">
                                <tr class="invoice-list">
                                    ...
                                    <td class=""><input type="text" class="ti-form-input" placeholder="Product name">
                                    </td>
                                    ...
                                    <td class="font-medium"><input type="number" class="ti-form-input"
                            ...
                            <tbody class="border-t border-b-0 border-x-0 border-gray-200 dark:border-white/10">
                                <tr class="!border-b-0">
                                    ...
                                    <td class="!pb-1"><input type="number" class=" ti-form-input"
                                ...
                                <tr class="!border-b-0 !border-t-0">
                                    ...
                                    <td class="!py-1"><input type="number" class=" ti-form-input" placeholder="Tax">
                                    </td>
                                    <td></td>
                                </tr>
                                <tr class="!border-b-0 !border-t-0">
                                    ...
                                    <td class="!py-1"><input type="number" class=" ti-form-input"
                                ...
                                <tr class="!border-t-0">
                                    ...
                                    <td class="!pt-1"><input type="number" class=" ti-form-input" placeholder="Total">
                                    </td>
                                    <td></td>
                                </tr>
                            </tbody>
