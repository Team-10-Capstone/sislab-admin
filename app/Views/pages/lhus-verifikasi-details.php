                            ...
                            <div class="col-span-12 xl:col-span-8">
                                <div class="grid grid-cols-2 gap-6 h-max">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <div id="hs-focus-management-modal<?php echo $permohonan['parameter_uji']['jenis_parameter']; ?>2"
                                                        ...
                                                        <div
                                                            class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out !max-w-2xl">
                                    ...
                                    <div class="box xl:col-span-2">
                                        <div class="box-header">
                                            <h5 class="box-title">Verifikasi</h5>
                                        </div>
                                        <div class="box-body">
                                            <div class="grid grid-cols-2">
                                                ...
                                                <form method="post"
                                                    ...
                                                    <button type="submit"
                                                        class="hs-dropdown-toggle w-full ti-btn btn ti-btn-primary cursor-pointer approve-button">
