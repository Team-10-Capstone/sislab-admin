                ...
                <div class="table-wrapper" style="background-color: white; display: inline-block; padding: 0px;">
                    ...
                    <div style="display:flex; justify-content:center; padding:8px">
                        ...
                        <table
                            ...
                            <tr>
                                <td style="font-weight: bold; padding-bottom: 4px; font-style: italic; border: none;">
                                    TEST
                                    RESULT</td>
                            </tr>
                            <tr>
                    ...
                    <div style="display:flex; justify-content:center; margin-top: 20px; ">
                        ...
                        <table style="border-collapse: collapse; background-color:white; width: 450px;">
                            ...
                            <tr>
                                ...
                                <td style="font-size: 14px; border: none;">Tanggal Penerimaan/ <br> <i>Receipt date</i>
                                </td>
                                <td style="font-size: 14px; border: none;">:</td>
                                <td style="font-size: 14px; border: none;">
                                    12/12/2020
                            ...
                            <tr>
                                ...
                                <td style="font-size: 14px; border: none;">Tanggal Pengujian/ <br> <i>Testing Date</i>
                                </td>
                                <td style="font-size: 14px; border: none;">:</td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="2" style="border: none;">Hasil uji ini mewakili populasi yang
                                        ...
                                        <i>The result of the test represent the population taken/This result of the test
                                            are
                                            only valid for the
                                            tested sample**)</i>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <!-- Menampilkan nomor urut -->
                                    <td width="1%" style="border: none;">.</td> <!-- Menampilkan nomor urut -->
                                    <td colspan="2" style="border: none;">Laporan hasil uji terdiri dari 1 (Satu) lembar
                                        asli (Stempel
                                        Asli)<br>
                                ...
                                <tr>
                                    ...
                                    <!-- Menampilkan nomor urut -->
                                    <td width="1%" style="border: none;">.</td> <!-- Menampilkan nomor urut -->
                                    <td colspan="2" style="border: none;">Laporan hasil uji ini tidak boleh digandakan,
                                        kecuali secara lengkap
                                        dan seizin tertulis Kepala Balai Besar Ui Standar KIPM (Stempel Copy)<br>
                                        <i>This report of test shall not be reproduced (copied) except for the completed
                                            one
                                            and with the
                                            written permission of the Head of Fish Quarantine and Inspection Standard
                    ...
                    <div style="display:flex; justify-content:center; margin-top: 40px; ">
                        ...
                        <table
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="border: none;">**) Coret yang tidak sesuai/<i>Cross out whichever does
                                            not
                                            apply</i></td>
                                </tr>
                            </tbody>
