                ...
                <form action="<?php echo base_url(); ?>RegisterController/store" method="post">
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-white">ini perubahan</p>
                        </div>
                        <!-- End Form Group -->
                        ...
                        <div class="flex items-center">
                            <label
                                class="flex w-full bg-white border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70">
                                <input type="checkbox" class="ti-form-checkbox mt-0.5 pointer-events-none"
                                    id="hs-checkbox-checked-in-form" id="terms" name="terms" required>
