                    ...
                    <div class="box">
                      <div class="box-body relative">
                        <div class="flex relative before:bg-black/50 before:absolute before:w-full before:h-full before:rounded-sm">
                          <img src="<?php echo base_url('assets/img/png-images/2.png'); ?>" alt="" class="h-[200px] w-full rounded-sm" id="profile-img2">
                        ...
                        <div class="absolute top-[4.5rem] inset-x-0 text-center space-y-3">
                          <div class="flex justify-center w-full">
                            <div class="relative">
                              <img src="<?php echo base_url('assets/img/users/1.jpg'); ?>" class="w-24 h-24 rounded-full ring-4 ring-white/10 mx-auto" id="profile-img" alt="pofile-img">
