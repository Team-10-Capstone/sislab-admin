    ...
    <?php endif; ?>
        ...
        <div class="box">
            <div class="box-header sm:flex sm:justify-between space-y-3 sm:space-y-0">
                <h5 class="box-title my-auto">Daftar Admin</h5>
                ...
                <div id="hs-focus-management-modal" class="hs-overlay hidden ti-modal">
                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                        <div class="ti-modal-content">
                            ...
                            <form id="create-admin" method="post" action="<?php echo base_url('admin/add'); ?>"
                                enctype="multipart/form-data">
                                <div class="ti-modal-body space-y-4">
                                    <label for="input-label" class="ti-form-label">Nama</label>
                                    <input type="text" id="name" class="ti-form-input" placeholder="Nama" autofocus
                                        name="name">
                                    <label for="input-label" class="ti-form-label">Email</label>
                                    <input type="text" id="email" class="ti-form-input" placeholder="Email" autofocus
                                        name="email">
                                    <label for="input-label" class="ti-form-label">Jabatan</label>
                                    ...
                                    <label for="input-label" class="ti-form-label">Password</label>
                                    <input type="password" id="password" class="ti-form-input" placeholder="Password" autofocus
                                        name="password">
                                </div>
                    ...
                    <table class="ti-custom-table ti-custom-table-head edit-table">
                        <thead class="bg-gray-100 dark:bg-black/20">
                            <tr class="">
                                ...
                                <th scope="col" class="dark:text-white/70">Jabatan</th>
                                ...
                                <tr class="product-list">
                                    ...
                                    <td class="text-center font-medium">
                                        ...
                                        <button type="button"
                                            ...
                                            data-hs-overlay="#hs-focus-management-modal<?php echo $admin['adminId']; ?>">
                                            <i class="ti ti-pencil"></i>
                                        </button>

                                        <div id="hs-focus-management-modal<?php echo $admin['adminId']; ?>"
                                            ...
                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                                <div class="ti-modal-content">
                                                    ...
                                                    <form id="edit-admin" method="post"
                                                        action="<?php echo base_url("admin/edit/{$admin['adminId']}"); ?>"
                                                        enctype="multipart/form-data">
                                                        <div class="ti-modal-body space-y-4">
                                                            <label for="input-label" class="ti-form-label">Nama</label>
                                                            <input type="text" id="name" class="ti-form-input"
                                                                value="<?php echo $admin['name']; ?>"
                                                                placeholder="Nama" name="name">
                                                            <label for="input-label" class="ti-form-label">Email</label>
                                                            <input type="text" id="email" class="ti-form-input"
                                                                value="<?php echo $admin['email']; ?>"
                                                                placeholder="email" name="email">
                                                            <label for="input-label" class="ti-form-label">Jabatan</label>
                                                            <select class="ti-form-select" id="select-beast" autocomplete="off"
                                                                name="roleId" value="<?php echo $admin['roleId']; ?>">
                                                                <option value="1"
                                                                    <?php if ($admin['roleId'] === 1) echo 'selected'; ?>>Manajer Teknis</option>
                                                                <option value="2"
                                                                <?php if ($admin['roleId'] === 2) echo 'selected'; ?>>Penyelia</option>
                                                                <option value="3"
                                                                <?php if ($admin['roleId'] === 3) echo 'selected'; ?>>Analis</option>
                                                                <option value="4"
                                                                <?php if ($admin['roleId'] === 4) echo 'selected'; ?>>Petugas LAB</option>
                                                            </select>
                                                            <label for="input-label" class="ti-form-label">Password</label>
                                                            <input type="password" id="password" class="ti-form-input"
                                        ...
                                        <a aria-label="anchor" href="<?php echo base_url("admin/delete/{$admin['adminId']}"); ?>"
