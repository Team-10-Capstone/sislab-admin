				...
				<nav class="main-header" aria-label="Global">
					...
					<div class="responsive-logo">
						<a class="responsive-logo-dark" href="javascript:void(0);" aria-label="Brand"><img
							src="<?php echo base_url('assets/img/brand-logos/desktop-logo.png'); ?>" alt="logo" class="mx-auto"></a>
						<a class="responsive-logo-light" href="javascript:void(0);" aria-label="Brand"><img
							src="<?php echo base_url('assets/img/brand-logos/desktop-dark.png'); ?>" alt="logo" class="mx-auto"></a>
					</div>
					...
					<div class="header-right">
						...
						<div class="header-nav-right">
							...
							<button id="dropdown-flag" type="button"
								...
								<img src="<?php echo base_url('assets/img/flags/10.png'); ?>" alt="flag-img" class="h-[1.375rem] w-[1.375rem]">
							</button>
							<div class="hs-dropdown-menu ti-dropdown-menu min-w-[10rem]" aria-labelledby="dropdown-flag">
								...
								<div class="py-2 first:pt-0 last:pb-0">
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										...
										<img src="<?php echo base_url('assets/img/flags/10.png'); ?>" alt="flag-img">
										</div>
										<div>
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
										<img src="<?php echo base_url('assets/img/flags/1.png'); ?>" alt="flag-img">
										</div>
										<div>
										<p class="text-xs font-medium">
											Argentina
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
										<img src="<?php echo base_url('assets/img/flags/2.png'); ?>" alt="flag-img">
										</div>
										<div>
										<p class="text-xs font-medium">
											Canada
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
										<img src="<?php echo base_url('assets/img/flags/3.png'); ?>" alt="flag-img">
										</div>
										<div>
										<p class="text-xs font-medium">
											France
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
										<img src="<?php echo base_url('assets/img/flags/4.png'); ?>" alt="flag-img">
										</div>
										<div>
										<p class="text-xs font-medium">
											Germany
									...
									<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
										<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
										<img src="<?php echo base_url('assets/img/flags/5.png'); ?>" alt="flag-img">
										</div>
										<div>
										<p class="text-xs font-medium">
											Italy
							...
							<div class="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-cart">
								...
								<div class="py-2 first:pt-0 last:pb-0" id="allCartsContainer">
									...
									<a href="javascript:void(0);" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
										<img loading="lazy" src="<?php echo base_url('assets/img/ecommerce/products/1.png'); ?>" alt="product-img"
									...
									<div class="ti-dropdown-item relative header-box">
									<a href="javascript:void(0);" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
										<img loading="lazy" src="<?php echo base_url('assets/img/ecommerce/products/2.png'); ?>" alt="product-img"
										class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
										<div>
										<p class="text-sm font-medium text-gray-800 dark:text-white">
											Tshirt For Men
									...
									<div class="ti-dropdown-item relative header-box">
									<a href="javascript:void(0);" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
										<img loading="lazy" src="<?php echo base_url('assets/img/ecommerce/products/9.png'); ?>" alt="product-img"
										class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
										<div>
										<p class="text-sm font-medium text-gray-800 dark:text-white">
									...
									<div class="ti-dropdown-item relative header-box">
									<a href="javascript:void(0);" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
										<img loading="lazy" src="<?php echo base_url('assets/img/ecommerce/products/10.png'); ?>" alt="product-img"
										class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
										<div>
										<p class="text-sm font-medium text-gray-800 dark:text-white">
							...
							<div class="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-notification">
								...
								<div class="py-2 first:pt-0 last:pb-0" id="allNotifyContainer">
									...
									<a href="javascript:void(0);" class="flex space-x-3 rtl:space-x-reverse">
										...
										<img src="<?php echo base_url('assets/img/users/17.jpg'); ?>" alt="img" class="rounded-sm">
										</div>
									...
									<a href="javascript:void(0);" class="flex items-center space-x-3 rtl:space-x-reverse">
										<div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
										<img src="<?php echo base_url('assets/img/users/2.jpg'); ?>" alt="img" class="rounded-sm">
										</div>
										<div class="relative w-full">
									...
									<a href="javascript:void(0);" class="flex items-center space-x-3 rtl:space-x-reverse">
										<div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
										<img src="<?php echo base_url('assets/img/users/21.jpg'); ?>" alt="img" class="rounded-sm">
										</div>
										<div class="relative w-full">
									...
									<a href="javascript:void(0);" class="flex items-center space-x-3 rtl:space-x-reverse">
										<div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
										<img src="<?php echo base_url('assets/img/users/11.jpg'); ?>" alt="img" class="rounded-sm">
										</div>
										<div class="relative w-full">
							...
							<div class="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-apps">
								...
								<div class="grid grid-cols-3 gap-0 p-4 pt-2">
									<a href="javascript:void(0);" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
