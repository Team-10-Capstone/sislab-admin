			...
			<aside class="app-sidebar" id="sidebar">
				...
				<div class="main-sidebar-header">
					<a href="<?php echo base_url('index'); ?>" class="header-logo">
						<img src="<?php echo base_url('assets/img/brand-logos/desktop-logo.png'); ?>" alt="logo" class="main-logo desktop-logo">
						<img src="<?php echo base_url('assets/img/brand-logos/toggle-logo.png'); ?>" alt="logo" class="main-logo toggle-logo">
						<img src="<?php echo base_url('assets/img/brand-logos/desktop-dark.png'); ?>" alt="logo" class="main-logo desktop-dark">
						<img src="<?php echo base_url('assets/img/brand-logos/toggle-dark.png'); ?>" alt="logo" class="main-logo toggle-dark">
					</a>
				</div>
						...
						<ul class="main-menu">
							...
							<li class="slide  has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide"><a href="<?php echo base_url('index'); ?>" class="side-menu__item">Sales</a></li>
								</ul>
							</li>
							<!-- End::slide -->
